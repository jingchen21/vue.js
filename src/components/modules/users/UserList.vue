       ...
       <bread-crumb></bread-crumb>
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="select_word" placeholder="搜索姓名关键词" class="handle-input mr10"></el-input>
            ...
            <el-table class="table_center" :data="data" border style="width: 100%;text-align:center;font-size: 14px;" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="头像" width="150">
                    <template slot-scope="scope">
                        <img :src="scope.row.ImgUrl" style="width:60px" />
                    </template>
                </el-table-column>
...
export default {
    ...
    computed: {
        data() {
            this.tableData.forEach(item => {
                item.ImgUrl = this.HostUrl + item.ImgUrl;
    ...
    methods: {
        ...
        //获取用户数据
        getData() {
            this.MyTools.$ajax.get.call(this,"/user/UserList?name="+this.select_word+"&page="+this.cur_page+"&pageSize="+this.cur_pageSize,res => {
                if(res.data.code==0){
        ...
        //删除处理
        delHandle() {
             this.MyTools.$ajax.get.call(this,"/user/DeleteItem?ids="+this.deleteIds,res => {
